...
-- Table `mydb`.`Ucet`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Ucet` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`BeznyUcet` (
  ...
  UNIQUE INDEX `jmenoUctu_UNIQUE` (`jmenoUctu` ASC) VISIBLE,
  CONSTRAINT `RegularAccount`
    FOREIGN KEY (`jmenoUctu`)
    REFERENCES `mydb`.`Ucet` (`jmenoUctu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`PodporaUcet`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`PodporaUcet` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `jmenoUctu` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `jmenoUctu_UNIQUE` (`jmenoUctu` ASC) VISIBLE,
  CONSTRAINT `SupportAccount`
    FOREIGN KEY (`jmenoUctu`)
    REFERENCES `mydb`.`Ucet` (`jmenoUctu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
